...
export default function Auth() {
    ...
    return (
      ...
      */}
                    ...
                    <form onSubmit={handlePhoneSubmit} className="space-y-8 text-center">
                        ...
                        <div className="pt-8">
                            <p className="text-xs text-slate-400 text-center leading-relaxed max-w-[320px] mx-auto">
                                By clicking Continue, you agree to our <a href="#" className="text-slate-600 font-semibold hover:text-[#34A853] underline decoration-slate-200 underline-offset-2 transition-colors">Terms of Service</a> and <a href="#" className="text-slate-600 font-semibold hover:text-[#34A853] underline decoration-slate-200 underline-offset-2 transition-colors">Privacy Policy</a>.
                            </p>
                        </div>
                    </form>
                )}
            ...
            ---------------------------------------------------- */}
                {step === "name" && (
                    <form onSubmit={handleNameSubmit} className="space-y-8 animate-in slide-in-from-right-8 duration-500 text-center">
                        <div className="space-y-3">
                            <h1 className="text-3xl font-extrabold tracking-tight text-[#0F172A]">
                                Welcome aboard! 🚀
                            </h1>
